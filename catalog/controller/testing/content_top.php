<?php  
class ControllerTestingContentTop extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/content_top.tpl')) {
			...
			$this->template = 'default/template/common/content_top.tpl';
                ...
                */
                if (file_exists(DIR_TEMPLATE . 'testingnaja/template/common/content_top.tpl')) {
			$this->template = 'testingnaja/template/common/content_top.tpl';
		} else {
			$this->template = 'default/template/common/content_top.tpl';
		}
                
                $this->data['hello'] = "<h2>Hello World.</h2>";
                $this->data['my_word'] = "This is the first time to be here.";
